...
for (y in from.year:to.year){
  ...
  if(final.dimensions == 2) {
    ...
    nc.file <- nc_create( paste(folder.data,"/currents_2d_",project.name,"_",y,".nc",sep=""), list(var1d,var2d,var3d,var4d,var5d) )
  ...
  if(final.dimensions == 3) {
    ...
    nc.file <- nc_create( paste(folder.data,"/currents_3d_",project.name,"_",y,".nc",sep=""), list(var1d,var2d,var3d,var4d,var5d,var6d) )
    ncvar_put( nc.file, var1d, Longitude.array )  
    ncvar_put( nc.file, var2d, Latitude.array )   
    ncvar_put( nc.file, var3d, as.numeric(time.window) )
